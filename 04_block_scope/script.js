...
// 'i' will be undefined because 'let' variables are not accesible from outside of block scope.
console.log(i);
...
// 'i' will be "11" because 'var' variables are accesible from outside of block scope.
console.log(i);
